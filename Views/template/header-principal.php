...
<head>
  ...
  <link rel="apple-touch-icon" href="<?php echo BASE_URL . 'assets/images/apple-icon.png'; ?>">
...
<body>
      ...
      <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
        <div class="flex-fill">
          <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo BASE_URL . 'principal/shop' ?>">Catálogo</a>
            </li>
            <li class="nav-item">
  ...
  <!-- Diseño del buscador de productos -->
